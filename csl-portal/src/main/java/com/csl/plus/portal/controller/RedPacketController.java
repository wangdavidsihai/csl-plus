...
public class RedPacketController {
	...
	@ResponseBody
	public Object update(@Validated @RequestBody SmsRedPacket smsRedPacket, BindingResult result) {
		CommonResult commonResult;
	...
	@ResponseBody
	public Object getList(SmsRedPacket redPacket, @RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum,
