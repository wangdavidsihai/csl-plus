...
import com.csl.plus.pms.entity.PmsProductConsult;
import com.csl.plus.pms.vo.ConsultTypeCount;
...
import com.csl.plus.portal.pms.service.IPmsProductAttributeService;
import com.csl.plus.portal.pms.service.IPmsProductCategoryService;
import com.csl.plus.portal.pms.service.IPmsProductConsultService;
...
public class PmsGoodsController {
	...
	public Object queryProductDetail(@RequestParam(value = "id", required = false, defaultValue = "0") Long id) {
		 ...
		 * productCollectionRepository.findByMemberIdAndProductId( umsMember.getId(),
		 * id); if (findCollection != null) { productResult.setIs_favorite(1); } else {
	...
	public Object getList(@RequestParam(value = "cid", required = false, defaultValue = "0") Long cid,
		...
		IPage<PmsProductAttribute> productAttributeList = productAttributeService.page(new Page<>(pageSize, pageNum),
				new QueryWrapper<>(q));
