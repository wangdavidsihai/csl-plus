...
public class ApiBaseAction {
	 ...
	 * request.getHeader(AuthorizationInterceptor.LOGIN_TOKEN_KEY); //查询token信息
	 * TokenEntity tokenEntity = tokenService.queryByToken(token); if (tokenEntity
	 * == null || tokenEntity.getExpireTime().getTime() <
	 * System.currentTimeMillis()) { return null; } return tokenEntity.getUserId();
	 * }
	 */
}
