...
public class SysPermissionController extends BaseController {
    ...
    public Object getRoleByPage(SysPermission entity,
        ...
        try {
            return new CommonResult().success(
                    sysPermissionService.page(new Page<SysPermission>(pageNum, pageSize), new QueryWrapper<>(entity)));
        } catch (Exception e) {
    ...
    public Object findPermissions() {
        ...
        return new CommonResult().success(sysPermissionService.getPermissionsByUserId(userId));
    }
     ...
     * 修改
     */
    @SysLog(MODULE = "sys", REMARK = "修改权限状态")
    @ApiOperation("修改权限状态")
