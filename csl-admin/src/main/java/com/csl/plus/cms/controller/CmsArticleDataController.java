...
public class CmsArticleDataController {
    ...
    public Object getCmsArticleDataByPage(CmsArticleData entity, @RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum,
			@RequestParam(value = "pageSize", defaultValue = "5") Integer pageSize){
        try {
			return new CommonResult()
					.success(cmsArticleDataService.page(new Page<CmsArticleData>(pageNum, pageSize), new QueryWrapper<>(entity)));
		} catch (Exception e) {
    ...
    @PreAuthorize("hasAuthority('cms:cmsarticledata:info')")
    public R info(@PathVariable("id") String id){
		CmsArticleDataEntity cmsArticleData = cmsArticleDataService.getById(id);
	...
	*/
    ...
    public Object save(@RequestBody CmsArticleData entity){
		try {
			if (cmsArticleDataService.saves(entity)) {
