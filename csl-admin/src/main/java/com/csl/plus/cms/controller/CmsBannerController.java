...
public class CmsBannerController {
    ...
    @RequestMapping("/list")
    @PreAuthorize("hasAuthority('cms:cmsbanner:list')")
    public Object getCmsBannerByPage(CmsBanner entity, @RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum,
     ...
     */
     /**
    @SysLog(MODULE = "cms", REMARK = "根据条件查询Banner List列表")
    @ApiOperation("根据条件查询Banner List列表") 
    @RequestMapping("/info/{id}")
    @PreAuthorize("hasAuthority('cms:cmsbanner:info')")
