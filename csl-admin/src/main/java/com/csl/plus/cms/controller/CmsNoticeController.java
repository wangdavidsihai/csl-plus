...
public class CmsNoticeController {
    ...
    @RequestMapping("/list")
    @PreAuthorize("hasAuthority('cms:cmsnotice:list')")
    public Object getCmsNoticeByPage(CmsNotice entity, @RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum,
    ...
    public R info(@PathVariable("id") String id){
		CmsNoticeEntity cmsNotice = cmsNoticeService.getById(id);
