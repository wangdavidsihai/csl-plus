...
public class CmsExpertController {
    ...
    @RequestMapping("/list")
    @PreAuthorize("hasAuthority('cms:cmsexpert:list')")
    public Object getCmsExpertByPage(CmsExpert entity, @RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum,
    ...
    @PreAuthorize("hasAuthority('cms:cmsexpert:info')")
    public R info(@PathVariable("id") Long id){
		CmsExpertEntity cmsExpert = cmsExpertService.getById(id);
