...
public class CmsArticleController {
    ...
    public Object getCmsArticleByPage(CmsArticle entity, @RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum,
			@RequestParam(value = "pageSize", defaultValue = "5") Integer pageSize){
        try {
			return new CommonResult()
					.success(cmsArticleService.page(new Page<CmsArticle>(pageNum, pageSize), new QueryWrapper<>(entity)));
		} catch (Exception e) {
    ...
    public R info(@PathVariable("id") String id){
		CmsArticleEntity cmsArticle = cmsArticleService.getById(id);
