...
@RequestMapping("res/projectCategory")
public class ResProjectCategoryController {
    @Autowired
    private IResProjectCategoryService resProjCategoryService;
    ...
    /**
     ...
     @GetMapping("/info/{id}")
     @PreAuthorize("hasAuthority('res:resprojcategory:info')") public R info(@PathVariable("id") Long id){
