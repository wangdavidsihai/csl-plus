...
import com.csl.plus.ums.service.IUmsMemberBlanceLogService;
...
public class UmsMemberBlanceLogController {
    ...
    public Object getUmsMemberBlanceLogByPage(UmsMemberBlanceLog entity,
        ...
        try {
            return new CommonResult().success(IUmsMemberBlanceLogService.page(new Page<UmsMemberBlanceLog>(pageNum, pageSize), new QueryWrapper<>(entity)));
        } catch (Exception e) {
